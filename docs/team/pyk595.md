...
- **Team-based tasks**:
    ...
    5. Changing user visible elements of AB-3 to AIA
    5. Debugging for teammates in online pair programming configuration
    6. PDF conversion for user guide and developer guide
    6. Review Pull Requests with non-trivial comments:
