...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + BIRTH_DATE_DESC_BOB
                + CONTACTED_DATE_BOB + CONTACTED_DESC_BOB
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid contacted date
        assertParseFailure(
                parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + BIRTH_DATE_DESC_BOB
                        + INVALID_CONTACTED_DATE + CONTACTED_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                RecentDate.MESSAGE_CONSTRAINTS
        );


        // invalid contacted description
        assertParseFailure(
                parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + BIRTH_DATE_DESC_BOB
                        + CONTACTED_DATE_BOB + INVALID_CONTACTED_DESC
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        ...
        assertParseFailure(
                ...
                INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + BIRTH_DATE_DESC_BOB
                        + VALID_CONTACTED_DATE_BOB + VALID_CONTACTED_DESC_BOB
