...
public class CommandTestUtil {
    ...
    public static final String VALID_NAME_DAVID = "David Ng";
    public static final String VALID_PHONE_AMY = "11111111";
    public static final String VALID_PHONE_BOB = "22222222";
    public static final String VALID_PHONE_DAVID = "33333333";
    public static final String VALID_EMAIL_AMY = "amy@example.com";
    public static final String VALID_EMAIL_BOB = "bob@example.com";
    public static final String VALID_EMAIL_DAVID = "david@example.com";
    public static final String VALID_ADDRESS_AMY = "Block 312, Amy Street 1";
    public static final String VALID_ADDRESS_BOB = "Block 123, Bobby Street 3";
    public static final String VALID_ADDRESS_DAVID = "Block 213, David Street 3";
    ...
    public static final String VALID_CONTACTED_DATE_DAVID = "2023-02-14";
    public static final String VALID_CONTACTED_DESC_AMY = "Meetup";
    public static final String VALID_CONTACTED_DESC_BOB = "PhoneCall";
    public static final String VALID_CONTACTED_DESC_DAVID = "Meeting";
    public static final String VALID_BIRTH_DATE_AMY = "2000-01-01";
    public static final String VALID_BIRTH_DATE_BOB = "2000-01-02";
    public static final String VALID_BIRTH_DATE_DAVID = "2000-01-03";
    public static final String VALID_TAG_HUSBAND = "husband";
    public static final String VALID_TAG_FRIEND = "friend";

    public static final String NAME_DESC_AMY = " " + PREFIX_NAME + VALID_NAME_AMY;
    public static final String NAME_DESC_BOB = " " + PREFIX_NAME + VALID_NAME_BOB;
    public static final String NAME_DESC_DAVID = " " + PREFIX_NAME + VALID_NAME_DAVID;
    public static final String PHONE_DESC_AMY = " " + PREFIX_PHONE + VALID_PHONE_AMY;
    public static final String PHONE_DESC_BOB = " " + PREFIX_PHONE + VALID_PHONE_BOB;
    public static final String PHONE_DESC_DAVID = " " + PREFIX_PHONE + VALID_PHONE_DAVID;
    public static final String EMAIL_DESC_AMY = " " + PREFIX_EMAIL + VALID_EMAIL_AMY;
    public static final String EMAIL_DESC_BOB = " " + PREFIX_EMAIL + VALID_EMAIL_BOB;
    public static final String EMAIL_DESC_DAVID = " " + PREFIX_EMAIL + VALID_EMAIL_DAVID;
    public static final String ADDRESS_DESC_AMY = " " + PREFIX_ADDRESS + VALID_ADDRESS_AMY;
    public static final String ADDRESS_DESC_BOB = " " + PREFIX_ADDRESS + VALID_ADDRESS_BOB;
    public static final String ADDRESS_DESC_DAVID = " " + PREFIX_ADDRESS + VALID_ADDRESS_DAVID;
    ...
    public static final String CONTACTED_DATE_DAVID = " " + PREFIX_CONTACTED_DATE + VALID_CONTACTED_DATE_DAVID;
    ...
    public static final String CONTACTED_DESC_DAVID = " " + PREFIX_CONTACTED_DESC + VALID_CONTACTED_DESC_DAVID;
    ...
    public static final String BIRTH_DATE_DESC_DAVID = " " + PREFIX_BIRTH_DATE + VALID_BIRTH_DATE_DAVID;
