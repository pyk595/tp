...
public class CommandTestUtil {
    ...
    public static final String INVALID_RECENT_DATE_DESC = " " + PREFIX_DATE + "random string"; // random string
    public static final String INVALID_CONTACTED_DESC = " " + PREFIX_DESCRIPTION; // empty string not allowed
